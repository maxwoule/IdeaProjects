...
public class Main {
    public static void main(String[] args) {
        ...
        Department higherSalaryDepartment = company.findDepartmentWithHigherSalary();
        System.out.println("Відділ з працівником, який отримує більше за свого начальника: " + higherSalaryDepartment.name);
